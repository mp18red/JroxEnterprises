...
class SigninsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create signin" do
    assert_difference('Signin.count') do
      post signins_url, params: { signin: { Candidate: @signin.Candidate, Iboname: @signin.Iboname } }
    end
  ...
  test "should update signin" do
    patch signin_url(@signin), params: { signin: { Candidate: @signin.Candidate, Iboname: @signin.Iboname } }
